    ...
    return (
        <div className="space-y-16 py-10">
            <div className="flex flex-col items-center text-center space-y-4 mb-20">
                <div className="px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-[0.4em]">
                    Behind the Build
                </div>
...
function DecisionHeatmapBox({ adr, index }: { adr: ADR; index: number }) {
    ...
    return (
        <motion.div
            ...
            className="relative"
        >
            <div className="glass-card-premium p-8 border-white/5 relative group overflow-hidden">
                ...
                <div className="relative z-10 space-y-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        <div className="lg:col-span-8 space-y-4">
                            <div className="flex items-center gap-4">
                                <span className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.4em]">Core Path {index + 1}</span>
                                <div className="h-[1px] flex-grow bg-white/5" />
                            </div>
                            <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-none group-hover:text-blue-400 transition-colors">
                                {adr.decision}
                            </h3>
                            <p className="text-zinc-400 text-lg leading-relaxed font-medium pl-6 border-l-2 border-blue-500/20 italic">
                                {adr.context}
                            </p>
                        </div>

                        <div className="lg:col-span-4 bg-white/[0.03] rounded-2xl p-6 border border-white/5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="space-y-4 p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 group/item">
                        ...
                        <div className="space-y-4 p-6 rounded-2xl bg-amber-500/5 border border-amber-500/10 group/item">
                        ...
                        <div className="space-y-4 p-6 rounded-2xl bg-blue-500/5 border border-blue-500/10 group/item">
                    ...
                    <div className="pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div className="flex items-center gap-6">
                            <div className="flex -space-x-2">
                                {adr.alternatives.slice(0, 3).map((alt, i) => (
                                    <div key={i} className="px-3 py-1.5 rounded-full bg-zinc-900 border border-white/10 text-[9px] font-bold text-zinc-500 uppercase tracking-wider backdrop-blur-xl">
                                        {alt}
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="flex items-center gap-4 justify-end">
                            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/[0.02] border border-white/5">
                                ...
                                <span className="text-[11px] text-zinc-400 font-black italic uppercase tracking-tighter">
