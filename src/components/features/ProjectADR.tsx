                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            <span className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] block">Alternatives Explored</span>
                                        ...
                                        <div className="grid grid-cols-1 gap-4 pt-2">
                                            <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10 space-y-2">
                                                <div className="flex items-center gap-2 text-emerald-400">
                                                    ...
                                                    <span className="text-[9px] font-black uppercase tracking-widest text-emerald-500/80">Positive Consequences</span>
                                                </div>
                                            ...
                                            <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/10 space-y-2">
                                                <div className="flex items-center gap-2 text-amber-400">
                                                    ...
                                                    <span className="text-[9px] font-black uppercase tracking-widest text-amber-500/80">Known Trade-offs</span>
                                                </div>
                                                <p className="text-[10px] text-zinc-400 leading-relaxed font-medium">
